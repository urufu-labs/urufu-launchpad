...
contract ERC1155WithSupplyPayableGen is ERC1155, Ownable {
    // ============================================================
    // Base errors — frozen
    // ============================================================
    ...
    function initialize(
        ...
        // --- from PayableMint1155.frag.sol ---
        {
            (uint256[] memory ids_, uint256[] memory prices_) = abi.decode(moduleData[0], (uint256[], uint256[]));
        ...
        // --- from SupplyPerToken1155.frag.sol ---
        {
            (uint256[] memory ids_, uint256[] memory caps_) = abi.decode(moduleData[1], (uint256[], uint256[]));
